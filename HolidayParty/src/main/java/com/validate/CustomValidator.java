...
public class CustomValidator implements Validator{
	...
	public void validate(Object target, Errors errors) {
		...
		ValidationUtils.rejectIfEmptyOrWhitespace(errors, "emailId", "field.required", 
			    "Email ID cannot be blank Should be a proper email ID format");

		ValidationUtils.rejectIfEmptyOrWhitespace(errors, "confirmEmailId", "field.required", 
			    "Confirm Email ID cannot be blank Should be a proper email ID format");
